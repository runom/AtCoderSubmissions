...
int main() {
    ...
    graph[0] = graph[1] = vector<vector<int>>(n);
    ...
    for (int i : rep(0, k)) {
        ...
        graph[0][p].push_back(q);
        graph[0][q].push_back(p);
    }
    ...
    for (int i : rep(0, l)) {
        ...
        graph[1][p].push_back(q);
        graph[1][q].push_back(p);
    }

    fill((int *)col, (int *)(col + 2), -1);
